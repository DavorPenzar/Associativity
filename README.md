...
The format of the [*CSV* files](http://en.wikipedia.org/wiki/Comma-separated_values) supported by the implemented parser is extensively described in the documentation of [`TableReader` class](app/src/main/java/com/penzart/associativity/TableReader.kt), more specifically [`TableReader.readCSV` method](app/src/main/java/com/penzart/associativity/TableReader.kt#L291), but essentially comes down to the following:
