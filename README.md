...
3.  [Encoding](http://en.wikipedia.org/wiki/Character_encoding) of [*CSV* files](http://en.wikipedia.org/wiki/Comma-separated_values) **must** be [*UTF-8*](http://en.wikipedia.org/wiki/UTF-8).
